...
for(i = 0; i<8;i++){
 ...
 output+="<div>" + play[0].songs[i].songTitle +" "+ play[0].songs[i].songAuthor + "</div>";
  output+="<div>" + play[0].songs[i].songLength + "</div>" ;
 output+="<div>" + play[0].songs[i].songListened + "</div>" ;
     }
